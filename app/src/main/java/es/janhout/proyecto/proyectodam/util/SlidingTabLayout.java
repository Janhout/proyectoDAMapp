 ...
 * alternative is via the {@link es.janhout.proyecto.proyectodam.util.SlidingTabLayout.TabColorizer} interface which provides you complete control over
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     * {@link #setCustomTabColorizer(es.janhout.proyecto.proyectodam.util.SlidingTabLayout.TabColorizer)}.
     */
    ...
    /**
     * Set the custom {@link es.janhout.proyecto.proyectodam.util.SlidingTabLayout.TabColorizer} to be used.
     *
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link es.janhout.proyecto.proyectodam.util.SlidingTabLayout} you are
